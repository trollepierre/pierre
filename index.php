  			  ...
  			  <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  				  <div class="container">
  					  <div class="navbar-header">
  						  ...
  						  <a class="navbar-brand" href="#perso">Pierre</a>
  					  </div>
  					  <div class="navbar-collapse collapse">
  						  <ul class="nav navbar-nav">
  							  <li class="active"><a href="#">Home</a></li>
  							  <li><a href="http://www.recontact.me">World Trip</a></li>
  							  <li><a href="http://wekit.recontact.me">WeKiT</a></li>
  							  <li><a href="http://coincollector.recontact.me">CoinCollector</a></li>
  							  <li class="dropdown">
  								  <a href="http://startup.recontact.me" class="dropdown-toggle" data-toggle="dropdown">Startup Ideas<b class="caret"></b></a>
  								  <ul class="dropdown-menu">
  									  <li><a href="http://startup.recontact.me">View All</a></li>
  									  <li><a href="http://startup.recontact.me">Holograms</a></li>
  									  <li><a href="http://startup.recontact.me">Something else here</a></li>
  									  <li class="divider"></li>
  									  <li class="dropdown-header">Help me</li>
  									  <li><a href="http://startup.recontact.me">Share ideas</a></li>
  									  <li><a href="http://startup.recontact.me">Apply</a></li>
  								  </ul>
  							  </li>
  	  ...
  	  <!-- Three columns of text below the carousel -->
  		  <div class="row three">
			  ...
			  <div class="col-lg-4">
   				 ...
   				 Get a look to my plans about this world trip.</p>
  			  ...
  			  <div class="col-lg-4">
   				 ...
   				 One day I pitched this idea & WeKiT was created!</p>
  			  ...
  			  <div class="col-lg-4">
   				 ...
   				 and become the market place for coin collectors. </p>
  				  <p><a class="btn btn-default" href="http://coincollector.recontact.me" role="button">Here is the deal &raquo;</a></p>
  			  </div><!-- /.col-lg-4 -->
  		  ...
  		  <div class="row featurette">
  			  <a id="perso"></a>  
   		  <div class="col-md-7">
  				  <h2 class="featurette-heading">One life to explore the whole world.<br/><span class="text-muted">Travelling is my religion.</span></h2>
  				  <p class="lead">Trekking in Himalaya.<br/>
  				  Discovering the Golden Temple of Amritsar, India.<br/>
  				  Visiting Maribor, Slovenia with friends.<br/>
  		  ...
  		  <div class="row featurette">
  			  ...
  			  <div class="col-md-7">
  				  ...
  				  <p class="lead">Create business by providing useful services for the world. <br/>Motivation and excitement come with the success of the start up. <br/>Being useful for the world, that's the deal!</p>
  			  </div>
  		  </div>
  		  ...
  		  <div class="row featurette">
  			  <div class="col-md-7">
  				  <h2 class="featurette-heading">Sharing fun with people.<br/> <span class="text-muted">Who cares about fun if there is nobody sharing it with you.</span></h2>
  				  <p class="lead">
  				      Meeting European in Serbia.
  				  <br/> Gather BEST France during the Join Board Training.
  				  <br/> Going out with friends.
